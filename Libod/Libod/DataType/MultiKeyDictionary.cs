...
namespace Libod.DataType
{
        public class MultiKeyDictionary<K1, K2, V>: Dictionary<K1, Dictionary<K2, V>>
        {
                ...
                /// <summary>
                /// je sais pas si ça marche faut tester - sbaudin 12/03/2014
                /// </summary>
                ...
                {
                        value = default (V);
                        Dictionary<K2, V> key2Dic = new Dictionary<K2, V> ();
                        if (!base.TryGetValue (key1, out key2Dic))
                        {
                                return false;
                        }
                        else
                        {
                                return key2Dic.TryGetValue (key2, out value);
                        }
                }
        }
